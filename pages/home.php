...
<main>
    <section class="hero">
        ...
        <div class="hero-buttons">
            <a href="view_flats.php" class="cta-button">Browse Flats</a>
            <div class="registration-buttons">
                <a href="customer_register.php" class="register-button customer">Register as Customer</a>
                <a href="owner_register.php" class="register-button owner">Register as Owner</a>
            </div>
        </div>
    </section>
    ...
    <section class="featured-flats">
        ...
        <div class="flats-grid">
            ...
            while ($flat = $stmt->fetch()) {
                ...
                echo '<a href="flat_detail.php?ref=' . htmlspecialchars($flat['ref_number']) . '" class="view-details">View Details</a>';
                echo '</div>';
                echo '</div>';
            }
            ?>
    ...
    <section class="about-preview">
        ...
        <a href="about_us.php" class="learn-more">Learn More</a>
    </section>
</main>
